...
In Hall A analyzer, the VDC result will given in detector plane coordinate system. The HRS optimization will take the those para and its derived combinations as input features to the HRS model.

After properly turn the model, give the coordinate in the DCS, the model will be able to give the infors on the target coordinate system which we need to do further analysis. 
