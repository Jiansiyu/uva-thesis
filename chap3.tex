...
$n$ is the refractive index o the medium. $\beta$ is the ratio between the speed of the particle and the speed of light $\beta = \frac{v_p}{c}$. For the PRex-II experiment, the Cerenkov photons are emitted at the angle of $\theta = 46.58\circ$. The main detector used in the experiment the total internal reflection angle is $\theta = 43.619\circ$. The design of the main detector, if the scattered electron near-normal incident in the quartz, the created photons will be trapped via total internal reflection and eventually the photons goes out the quartz from the $45\circ$ surface where it connected to the PMT and eventually detect by the PMT. 
...
The PRex-I experiment, the incident angle was $~45\circ$, which means half of the Cerenkov light cone went directly to the PM while the other half escaped from the tile and was mostly lost. The PRex-I experiment does not require high-precision detector orientation alignment. The PRex-II quartz design needs to aligh within $~3\circ$ angle to be able to make use of the total internal reflection property. The PRex-II quartz detector design will be able to collect most of the Cerenkov light if the main detector is carefully alighted. The light yields and the resolution can be increased by a factor of 2. 
