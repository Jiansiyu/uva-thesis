...
In the previous select, the calibration of from the detector coordinate system to the focal plane coordinate system have been introduced. This section will cover the The HRS Optics from the focal plane to the target coordinate system. 
