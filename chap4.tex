...
\section{Spectrometer central $\theta_0$ measurement}



HRS pointing angle is a critical parameter for scattered angle measurement. We did a survey with a laser before the experiment. But it only gives about 0.06 accuracy. 

The point measure is the electron scattered over the water target. For the oxygen and hydrogen targets, we will have the same scattered angle. We can measure the scattered electron energy difference between H and O, and with the knowledge of H O mass, and the beamE. The pointing angle can be calculated. 
